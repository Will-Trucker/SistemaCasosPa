    ...
    <div class="contendor">
        <div class="wrapper">
            ...
            <form action="#">
                <div class="dbl-field">
                    <div class="field">
                        <input type="text" name="" placeholder="Porcentaje de desarrollo">
                        <i class="fa-solid fa-file-lines"></i>
                    </div>
                </div>
                <div class="message">
                    <textarea placeholder="Actualizar bitacora" name="message"></textarea>
                    <i class="fa-regular fa-newspaper"></i>
                </div>

                <div class="button-area">
                    <button type="submit" style="margin-right: 30px !important;">Terminar</button>
                    <span></span>
                    <br>
                    <!-- <br><br><br><br><br><br><br><br> -->
                    <button type="submit" style="margin-right: 30px !important;">Actualizar</button>
                    <span></span>
                    <!-- <br><br><br><br><br><br><br><br> -->
